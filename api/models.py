...
dos estados observados a cada coleta; `collection_runs` registra cada execucao.
As tecnologias sao uma relacao muitos-para-muitos com o snapshot, e nao uma string
"Excel, Python, SQL", porque e isso que permite filtrar e contar de verdade.
Veja docs/data-model.md.
"""
